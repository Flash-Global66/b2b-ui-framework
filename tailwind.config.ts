  ...
  theme: {
    extend: {
      ...
      textColor: {
        ...
        success: 'var(--color-txt-success)',
        error: 'var(--color-txt-error)',
        warning: 'var(--color-txt-warning)',
        info: 'var(--color-txt-info)',
      },
      borderColor: {
    ...
    plugin(({ addBase, theme }) => {
      addBase({
        ':root': {
          ...
          '--color-txt-tertiary': theme('colors.grey.500'),
          ...
          '--color-border-primary': theme('colors.nightBlue.900'),
