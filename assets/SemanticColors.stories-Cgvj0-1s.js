import{G as c}from"./ConfigProvider-CVsr_Nb2.js";import"./vue.esm-bundler-CH9yNyng.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const p={title:"Colores/Semantic",parameters:{docs:{description:{component:`
...
> **Nota**: Click en cualquier color copia su nombre semántico al portapapeles. 📋
        `}}}},n=()=>({components:{GConfigProvider:c},template:`
  <g-config-provider>
  ...
  `,setup(){return{handleColorClick:async i=>{try{await navigator.clipboard.writeText(i)}catch(s){console.error("Error al copiar:",s)}}}}}),l=n.bind({});var e,r,t;l.parameters={...l.parameters,docs:{...(e=l.parameters)==null?void 0:e.docs,source:{originalSource:`() => ({
  components: {
    GConfigProvider
  },
  template: \`
...
})`,...(t=(r=l.parameters)==null?void 0:r.docs)==null?void 0:t.source}}};const f=["Default"];export{l as Default,f as __namedExportsOrder,p as default};
