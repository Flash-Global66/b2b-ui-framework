...
El editor te mostrará las opciones disponibles gracias al tipado estricto.
        `}}},argTypes:{name:{description:"Nombre completo del icono (peso + nombre)",control:"select",options:i(),table:{type:{summary:"string"},defaultValue:{summary:"solid user"}}}},args:{name:"solid user"}},a={name:"Uso básico",render:o=>({components:{GIconFont:l,GConfigProvider:y},setup(){return{args:o}},template:`
      <g-config-provider>
        <div class="flex flex-col gap-4">
          <g-icon-font v-bind="args" class="text-8 text-grey-700"/>
        </div>
      </g-config-provider>
    `})},s={name:"Galería de iconos",parameters:{docs:{description:{story:"Galería completa de íconos disponibles en el sistema. Haz clic en cualquier ícono para copiar su nombre. 📋"}}},render:()=>({components:{GIconFont:l,GConfigProvider:y,GSegmented:O,GInput:N,GButton:_},setup(){const o=m("regular"),r=m(""),n=G(()=>{if(!r.value.trim())return t;const e=r.value.toLowerCase().trim();return Object.entries(t).reduce((p,[I,S])=>(p[I]=S.filter(T=>T.toLowerCase().includes(e)),p),{})}),c=()=>{r.value=""},k=Object.keys(t).map(e=>({label:e.charAt(0).toUpperCase()+e.slice(1),value:e}));return{iconSets:t,selectedWeight:o,weightOptions:k,copyIconName:e=>{navigator.clipboard.writeText(e).then(()=>{console.log("Nombre del icono copiado al portapapeles")}).catch(()=>{alert("No se pudo copiar el nombre del icono")})},searchTerm:r,clearSearch:c,filteredIcons:n}},template:`
      <g-config-provider>
        <div class="space-y-8">
          <g-segmented
            block
    ...
    `})};var d,g,u;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`() => {
  ...
  return options;
}`,...(u=(g=i.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var h,f,v;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: 'Uso básico',
  render: args => ({
    components: {
      GIconFont,
...
}`,...(v=(f=a.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var w,b,x;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
}`,...(x=(b=s.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};const ae=["generateIconOptions","Primary","Galería"];export{s as Galería,a as Primary,ae as __namedExportsOrder,ie as default,i as generateIconOptions};
