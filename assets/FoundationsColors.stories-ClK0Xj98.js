import{G as s}from"./ConfigProvider-CVsr_Nb2.js";import"./vue.esm-bundler-CH9yNyng.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const v={title:"Colores/Foundations",parameters:{docs:{description:{component:`
...
Al hacer click en el color automáticamente se copia la variante de tailwind en el portapapeles. 📋
        `}}}},n=()=>({components:{GConfigProvider:s},template:`
  <g-config-provider>
    <div>
  ...
  `,setup(){return{handleColorClick:async r=>{const t=[...r.target.classList].find(e=>e.startsWith("bg-")&&!e.startsWith("bg-[#")).split("-").slice(1).join("-");try{await navigator.clipboard.writeText(t)}catch(e){console.error("Error al copiar:",e)}}}}}),o=n.bind({});var i,l,d;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`() => ({
  components: {
    GConfigProvider
  },
  template: \`
...
})`,...(d=(l=o.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};const f=["Default"];export{o as Default,f as __namedExportsOrder,v as default};
